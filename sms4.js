...
document.getElementById("j_idt1554-history_form-new_comment").value ='Дано смс ответственному подразделению' ;
$( "button[id='j_idt1554-history_form-add_comment']" ).click();
