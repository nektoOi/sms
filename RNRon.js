...
var r = "РНР № " + namb + " на  оборудование связи, кабель, оборудование электропитания, информационные технологии МЕСТО ПРОВЕДЕНИЯ: " + place + " ВЛИЯНИЕ НА УСЛУГИ:  доступ в Интернет, интерактивное ТВ, Wi-Fi, VPN, телефонная связь, степень влияния на них: недоступность, ухудшение качества, кратковременное пропадание до " + time +  "  для " + abon + " клиентов.";
